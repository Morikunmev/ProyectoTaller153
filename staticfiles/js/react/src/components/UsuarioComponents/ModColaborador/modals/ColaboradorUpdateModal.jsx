...
import { useColaboradorUpdateModal } from "../hooks/useColaboradorUpdateModal";

const ColaboradorUpdateModal = ({
 isOpen,
 onClose,
 colaborador,
               ...
               {previewUrl && (
                 <div className="relative group">
                   ...
                   <div className="text-xs mt-1 text-gray-500">
                     {formData.FotoUsuario instanceof File
...
export default ColaboradorUpdateModal;