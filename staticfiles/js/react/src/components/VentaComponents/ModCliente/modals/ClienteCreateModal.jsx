...
const ClienteCreateModal = ({ isOpen, onClose, onClienteCreated }) => {
 ...
 const handleSubmit = async (e) => {
   ...
   try {
     ...
     if (!response.ok) {
       throw new Error(data.errors || "Error al crear el cliente");
     }
 ...
 return (
   <div className={`fixed top-16 right-0 bottom-0 w-[448px] bg-white shadow-xl z-40
     ...
     {/* Contenido scrolleable - Mismo formulario que en UpdateModal */}
     <div className="flex-1 overflow-y-auto">
       <div className="p-4">
         <form onSubmit={handleSubmit} className="space-y-4">
           {/* Los mismos campos que ClienteUpdateModal */}
           <div>
