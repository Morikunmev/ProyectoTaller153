...
import { useHerramientaCreateModal } from "../hooks/useHerramientaCreateModal";

const HerramientaCreateModal = ({ isOpen, onClose, onSubmit }) => {
  ...
  const {
    ...
    handleRemoveFoto,
    envios,
  } = useHerramientaCreateModal({ isOpen, onClose, onSubmit });
    ...
    >
      ...
      <div className="flex-none border-b">
        <div className="p-4 flex items-center justify-between">
          <h2 className="text-lg font-semibold">Nueva Herramienta</h2>
          <button
            onClick={handleClose}
...
export default HerramientaCreateModal;
