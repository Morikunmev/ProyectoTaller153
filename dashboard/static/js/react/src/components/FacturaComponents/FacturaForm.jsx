...
const FacturaForm = () => {
    const envios = [
        { destino: 'Lima', fecha: '2024-01-01', remitente: 'Juan Pérez', direccion: 'Av. Principal 123' },
        { destino: 'Arequipa', fecha: '2024-01-02', remitente: 'María García', direccion: 'Jr. Secundario 456' }
    ];
