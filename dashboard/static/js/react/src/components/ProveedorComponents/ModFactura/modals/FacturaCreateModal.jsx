        ...
        <div className="p-4">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              {/* Número de Factura */}
              <div>
                <label className="text-sm font-medium block mb-1">Número de Factura*</label>
                <input
                  type="text"
                  name="NumeroFactura"
                ...
                {errors.NumeroFactura && (
                  <p className="text-xs text-red-500 mt-1">{errors.NumeroFactura}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.FechaEmision && (
                  <p className="text-xs text-red-500 mt-1">{errors.FechaEmision}</p>
                )}
              </div>
            ...
            <div className="space-y-4">
              ...
              {/* Foto de la Factura */}
              <div>
                <label className="text-sm font-medium block mb-1">Foto de la Factura</label>
                ...
                {errors.FotoFactura && (
                  <p className="text-xs text-red-500 mt-1">{errors.FotoFactura}</p>
                )}
              </div>

              {/* Documento de la Factura */}
              <div>
                <label className="text-sm font-medium block mb-1">Documento de la Factura</label>
                <div className="mt-1 flex items-center space-x-4">
                  <input
                    type="file"
                ...
                {errors.DocumentoFactura && (
                  <p className="text-xs text-red-500 mt-1">{errors.DocumentoFactura}</p>
                )}
              </div>
            </div>
